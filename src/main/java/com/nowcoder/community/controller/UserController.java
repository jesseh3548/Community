...
public class UserController implements CommunityConstant {
    ...
    public void getHeader(@PathVariable("fileName") String fileName, HttpServletResponse response) {
        ...
        try (
                FileInputStream fis = new FileInputStream(fileName);//finally中自动关闭
    ...
    public String changePassword(String formerpassword, String newpassword, Model model) {

        int userId = hostHolder.getUser().getId();
        Map<String, Object> map = userService.changePassword(userId, formerpassword, newpassword);
