...
//        return userMapper.updateHeader(userId, headerUrl);
    ...
    public Map<String, Object> changePassword(int userId,String formerPassword, String newPassword) {

        Map<String, Object> map = new HashMap<>();
        User user = userMapper.selectById(userId);

        if (StringUtils.isBlank(formerPassword)) {
        ...
        String password = CommunityUtil.md5(formerPassword + user.getSalt());
